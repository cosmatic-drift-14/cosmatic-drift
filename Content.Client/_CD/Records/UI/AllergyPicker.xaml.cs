...
public sealed partial class AllergyPicker : FancyWindow
{
    [Dependency] private readonly IPrototypeManager _prototypeManager = default!;

    private readonly Texture _textureWhite;

    public Action<Dictionary<ReagentPrototype, FixedPoint2>>? OnUpdateAllergies;
    ...
    public AllergyPicker()
    {
        ...
        CIntensityButton.OnItemSelected += args =>
        {
            ...
            OnUpdateAllergies?.Invoke(_currentAllergies);
        };
    }
    ...
    private void AllergyAdd()
    {
        ...
        CIntensityButton.SelectId((int)Intensity.Moderate);
        CAllergyAttributes.Visible = true;
