...
public abstract class SharedStorageSystem : EntitySystem
{
    ...
    {
        if (args.Handled || !args.Complex || !strorageComp.OpenOnActivate || _combatMode.IsInCombatMode(args.User) || TryComp(uid, out LockComponent? lockComponent) && lockComponent.Locked)
            return;
