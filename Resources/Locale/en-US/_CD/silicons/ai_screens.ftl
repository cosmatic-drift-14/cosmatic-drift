...
station-ai-icon-gentoo = Old Systems
station-ai-icon-glitchman = Glitchman
station-ai-icon-goon = Relic
...
station-ai-icon-president = Public Speaker
station-ai-icon-rainbow = Rainbow
station-ai-icon-red = Red Ghost
...
station-ai-icon-evil-dot = Not Dave
