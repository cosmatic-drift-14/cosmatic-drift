...
game-ticker-player-join-game-message = Welcome to Cosmatic Drift! If this is your first time playing, be sure to read the game rules, and don't be afraid to ask for help in LOOC (local OOC) or OOC (usually available only between rounds). Don't feel afraid to ahelp! The admins happy to modify your character, give you an antag role, and do many other things. The worst they can say is no.
